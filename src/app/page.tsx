    ...
    <section className="py-20 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Interactive comparison showing the transformation from QGIS visualization to APK model clustering
          </p>
        </motion.div>
        ...
        >
          <div className="relative w-full h-96 md:h-[500px]">
            ...
            <div className="absolute inset-0">
              <img 
                src="/step3_qgis_ndvi.png" 
                alt="QGIS NDVI"
                className="w-full h-full object-cover"
              />
              <div className="absolute top-4 left-4 px-4 py-2 bg-black/70 rounded-lg">
                <span className="text-white font-medium">QGIS NDVI</span>
              </div>
            </div>
            ...
            >
              <img 
                src="/step4_apk_output.png" 
                alt="APK Model Output"
                className="w-full h-full object-cover"
              />
              <div className="absolute top-4 right-4 px-4 py-2 bg-black/70 rounded-lg">
                <span className="text-white font-medium">APK Clustered</span>
              </div>
            </div>
            
            {/* Slider Line */}
            <div 
              className="absolute top-0 bottom-0 w-1 bg-gradient-to-b from-green-400 to-blue-400 shadow-lg"
        ...
        <div className="text-center mt-8">
          <p className="text-gray-400">
            Drag the slider to compare QGIS visualization with APK model clustering results
          </p>
        </div>
      </div>
    </section>
